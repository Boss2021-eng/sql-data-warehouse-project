...
Describe dw_silver.crm_prd_info;
...
-- moving on the erm_cust_az12
-- Check for id not in customer information
SELECT 
* FROM 
(
...
-- cst_key AW00011000 missing in the cust_info key
...
-- for the erm_loc_a101 column
-- 1. Check for cid that are not in the custom info table 
SELECT DISTINCT CID
...
-- 2 Check for the unique countries in this table
SELECT DISTINCT CNTRY
FROM dw_silver.erm_loc_a101;

-- The final table erm_px_cat_giv2
